...
alias work='cd $HOME/workspace/projects/'
alias workgo='cd $HOME/workspace/projects/go'
alias workggh='cd $HOME/workspace/projects/go/src/github.com'
alias workgop='cd $HOME/workspace/projects/go/src/github.com/phoenixcoder'

# Golang Configuration
export GOPATH="$HOME/workspace/projects/go"
export GOBIN="$HOME/workspace/projects/go/bin"

# General User Settings
# TODO Install command for Python
export PATH=$PATH:$HOME/Library/Python/3.7/bin
export PATH=$PATH:${GOPATH}/bin
# TODO Install command for miniconda
export PATH=$PATH:$HOME/miniconda3/bin
# TODO Install for mongodb
export PATH=$PATH:$HOME/workspace/projects/lib/mongodb-macos-x86_64-4.2.0/bin
